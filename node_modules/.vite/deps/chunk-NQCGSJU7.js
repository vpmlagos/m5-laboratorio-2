...
function useUncontrolledProp(propValue, defaultValue, handler) {
  var wasPropRef = (0, import_react21.useRef)(propValue !== void 0);
  var _useState = (0, import_react21.useState)(defaultValue), stateValue = _useState[0], setState = _useState[1];
  ...
  return [isProp2 ? propValue : stateValue, (0, import_react21.useCallback)(function(value) {
...
function useUncontrolled(props, config) {
  return Object.keys(config).reduce(function(result, fieldName) {
    var _extends2;
    var _ref = result, defaultValue = _ref[defaultKey(fieldName)], propsValue = _ref[fieldName], rest = _objectWithoutPropertiesLoose2(_ref, [defaultKey(fieldName), fieldName].map(_toPropertyKey));
...
var TransitionGroupContext_default = import_react23.default.createContext(null);
...
var Transition = function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return (
      ...
      import_react24.default.createElement(TransitionGroupContext_default.Provider, {
        value: null
...
function useMergedRefs(refA, refB) {
  return (0, import_react25.useMemo)(() => mergeRefs(refA, refB), [refA, refB]);
}
...
var TransitionWrapper = import_react26.default.forwardRef(({
  onEnter,
  onEntering,
  onEntered,
  onExit,
    ...
    children: [indicators && (0, import_jsx_runtime5.jsx)("div", {
      ...
      children: map(children, (child, index) => {
        ...
        return slide ? (0, import_jsx_runtime5.jsx)(TransitionWrapper_default, {
          ...
          children: (status, innerProps) => React9.cloneElement(child, {
            ...innerProps,
...
//# sourceMappingURL=chunk-NQCGSJU7.js.map
